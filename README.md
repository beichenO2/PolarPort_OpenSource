...
> GUI 嵌入 [PolarCopilot](https://github.com/beichenO2/PolarCopilot) Hub Console 的 SSoT / 端口视图。用 Cursor **Open Folder** 打开本仓库根目录预览 Markdown 图片。

![Hub 端口视图 — PolarCopilot Console embed](screenshots/hub-dashboard.png)
